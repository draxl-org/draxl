...
The current detailed semantic-conflict example is documented in
...
- a first semantic-conflict rule for `let` binding rename versus initializer
  change
- a Git reproduction showing that text merge can succeed without surfacing the
