...
[syntax.md](syntax.md) executable and schema-backed for the
...
- update `README.md`
- update `docs/patching/semantics.md`
- update `docs/patching/syntax.md`
...
1. Fix the spec gaps in `syntax.md`.
